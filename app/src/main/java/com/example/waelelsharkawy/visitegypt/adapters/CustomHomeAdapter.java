...
public class CustomHomeAdapter extends ArrayAdapter<Places> {
    ArrayList<Places> PlacesList;

    public CustomHomeAdapter(Context context, int textViewResourceId, ArrayList<Places> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        view = inflater.inflate(R.layout.row_home_layout, null);
        ...
        TextView tx_place_desc = view.findViewById(R.id.tx_place_desc);
        im_place_image.setImageResource(list1.getImage());
        tx_place_name.setText(list1.getName());
        tx_place_desc.setText(list1.getDescription());
        return view;
    }
}
